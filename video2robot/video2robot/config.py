...
class CogVideoConfig:
    """CogVideo video generation config"""
    model_id: str = "THUDM/CogVideoX-5b"  # or "THUDM/CogVideoX-2b"
    enable_sequential_cpu_offload: bool = True
    enable_slicing: bool = True
    num_inference_steps: int = 50
    guidance_scale: float = 6.0
    use_quantization: bool = False  # Load in 8-bit/4-bit (requires bitsandbytes, not for MPS)
...
class PipelineConfig:
    ...
    cogvideo: CogVideoConfig = field(default_factory=CogVideoConfig)
