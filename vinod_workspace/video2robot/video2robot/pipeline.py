...
from .video.cogvideo_client import CogVideoClient
...
class Pipeline:
    ...
    def __init__(self, config: Optional[PipelineConfig] = None):
        ...
        self._cogvideo_client: Optional[CogVideoClient] = None
    ...
    @property
    def cogvideo_client(self) -> CogVideoClient:
        if self._cogvideo_client is None:
            self._cogvideo_client = CogVideoClient(
                model_id=self.config.cogvideo.model_id,
                dtype=self.config.cogvideo.dtype,
                enable_sequential_cpu_offload=self.config.cogvideo.enable_sequential_cpu_offload,
                enable_slicing=self.config.cogvideo.enable_slicing,
            )
        return self._cogvideo_client
